...
def parse_args(args=sys.argv[1:]):
    ...
    parser.add_argument(
        "--input",
        "The root directory of the oblique volume tree. The program expects "
    ...
    parser.add_argument(
        "--output",
        "The directory for the precomputed volume output"
    )
    parser.add_argument(
        "--levels",
...
def main(args=sys.argv[1:]):
    ...
    run(volumes, directory, opts.n_workers, opts.silent)
    directory.close()
